...
@section('content')
          ...
          .custom-table thead th:nth-child(1) { /* No */
              background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);
          }

          .custom-table thead th:nth-child(2) { /* Nama */
              background: linear-gradient(135deg, #f093fb 0%, #f5576c 100%);
          }

          .custom-table thead th:nth-child(3) { /* Agama */
              background: linear-gradient(135deg, #4facfe 0%, #00f2fe 100%);
          }

          .custom-table thead th:nth-child(4) { /* Pekerjaan */
              background: linear-gradient(135deg, #43e97b 0%, #38f9d7 100%);
          }

          .custom-table thead th:nth-child(5) { /* Jenis Kelamin */
              background: linear-gradient(135deg, #fa709a 0%, #fee140 100%);
          }

          .custom-table thead th:nth-child(6) { /* Email */
              background: linear-gradient(135deg, #a8edea 0%, #fed6e3 100%);
              color: #333;
          }

          .custom-table thead th:nth-child(7) { /* No HP */
              background: linear-gradient(135deg, #cd9cf2 0%, #f6f3ff 100%);
              color: #333;
          }

          .custom-table thead th:nth-child(8) { /* Aksi */
