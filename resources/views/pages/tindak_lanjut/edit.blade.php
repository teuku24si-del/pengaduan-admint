    ...
    <div class="content-wrapper">
        ...
        <div class="d-xl-flex justify-content-between align-items-start mb-4">
            ...
            <div class="d-flex gap-2">
                <a href="{{ route('tindak_lanjut.index') }}" class="btn btn-light">
        ...
        <div class="row">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center mb-4">
                            <div>
                                <h4 class="card-title mb-0">Form Edit Tindak Lanjut</h4>
                                <p class="card-description mb-0">Perbarui data tindak lanjut pengaduan</p>
                            </div>
                            <div class="badge badge-warning p-2">
                                ID: {{ $datatindak_lanjut->tindak_id }}
                            </div>
                        </div>
                        ...
                        <form action="{{ route('tindak_lanjut.update', $datatindak_lanjut->tindak_id) }}" method="POST" id="tindakLanjutForm">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <select name="pengaduan_id" id="pengaduan_id"
                                        ...
                                        {{ $datatindak_lanjut->pengaduan_id ? 'disabled' : '' }}>
                            ...
                            <div class="alert alert-info border-0 mb-4">
                                <div class="d-flex">
                                    ...
                                    <div>
                                        <h6 class="alert-heading mb-2">Informasi Pengaduan</h6>
                                        ...
                                        <p class="mb-0"><strong>Dibuat:</strong> {{ $datatindak_lanjut->pengaduan->created_at->format('d/m/Y') }}</p>
                                    </div>
                                </div>
                            </div>
                            @endif
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="font-weight-medium text-dark">
                                            <i class="mdi mdi-calendar mr-1"></i>Tanggal Dibuat
                                        </label>
                                        <input type="text" class="form-control bg-light"
                                               value="{{ $datatindak_lanjut->created_at->format('d/m/Y') }}" readonly>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control bg-light"
                                               value="{{ $datatindak_lanjut->updated_at->format('d/m/Y') }}" readonly>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group pt-3">
                                <div class="d-flex justify-content-between">
                                    ...
                                    <div>
                                        <a href="{{ route('tindak_lanjut.index') }}" class="btn btn-secondary mr-2">
            ...
            <div class="col-lg-4">
                        ...
                        <div class="alert alert-warning border-0 mb-4">
                            <div class="d-flex">
                                ...
                                <div>
                                    ...
                                    <p class="mb-0 small">Pastikan data yang diupdate sudah benar. Perubahan tidak dapat dibatalkan.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mt-4 pt-3 border-top">
                            ...
                            <div class="small">
                                ...
                                <div class="mb-2">
                                    ...
                                    @switch($datatindak_lanjut->aksi)
                                        ...
                                        @case('ditolak')
                                            ...
                                            @break
                                        @default
                                            <span class="badge badge-secondary ml-2">{{ $datatindak_lanjut->aksi }}</span>
                                    @endswitch
                                </div>
                                <div class="mb-2">
                                ...
                                <div class="mb-2">
                                    ...
                                    <span class="ml-2">{{ $datatindak_lanjut->created_at->format('d/m/Y') }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <h6 class="font-weight-medium text-dark mb-3">
                            <i class="mdi mdi-eye-outline mr-1"></i>Preview Perubahan
                        </h6>
                                ...
                                <span class="preview-aksi text-muted">
                                    @switch($datatindak_lanjut->aksi)
                                        ...
                                        @case('ditolak')
                                            ...
                                            @break
                                        @default
                                            <span class="badge badge-secondary">{{ $datatindak_lanjut->aksi }}</span>
                                    @endswitch
                                </span>
                            </div>
                            <div class="preview-item mb-2">
