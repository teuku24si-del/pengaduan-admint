            ...
            <div class="card card-gradient">
                <div class="card-body">
                    <div class="header-section mb-4">
                        <h4 class="card-title mb-2">Form Kategori Pengaduan</h4>
                        <p class="card-description">Isi form berikut untuk menambahkan kategori pengaduan baru</p>
                    </div>

                    <form class="forms-sample" action="{{ route('kategori_pengaduan.store') }}" method="POST">
                        @csrf
                                ...
                                <div class="form-group form-card">
                                    ...
                                    <div class="input-group input-group-gradient">
                                        <input type="number" class="form-control" id="sla_hari" name="sla_hari"
                                            placeholder="Masukkan jumlah hari" value="{{ old('sla_hari') }}"
                                            min="1" required>
                                        <div class="input-group-append">
                                            <span class="input-group-text">
                                            ...
                                            <div class="col-md-3 mb-2">
                                                <div class="radio-card">
                                                    <input type="radio" id="rendah" name="prioritas" value="rendah"
                                                        class="radio-input" {{ old('prioritas') == 'rendah' ? 'checked' : '' }} required>
                                            ...
                                            <div class="col-md-3 mb-2">
                                                <div class="radio-card">
                                                    <input type="radio" id="sedang" name="prioritas" value="sedang"
                                                        class="radio-input" {{ old('prioritas') == 'sedang' ? 'checked' : '' }}>
                                            ...
                                            <div class="col-md-3 mb-2">
                                                <div class="radio-card">
                                                    <input type="radio" id="tinggi" name="prioritas" value="tinggi"
                                                        class="radio-input" {{ old('prioritas') == 'tinggi' ? 'checked' : '' }}>
                                            ...
                                            <div class="col-md-3 mb-2">
                                                <div class="radio-card">
                                                    <input type="radio" id="sangat_tinggi" name="prioritas" value="sangat_tinggi"
                                                        class="radio-input" {{ old('prioritas') == 'sangat_tinggi' ? 'checked' : '' }}>
                            ...
                            <div class="col-md-12">
                                <div class="d-flex justify-content-center">
                                    <button type="submit" class="btn btn-primary-gradient btn-lg mr-3">
                                        <i class="mdi mdi-content-save mr-2"></i> Simpan Kategori
                                    </button>
