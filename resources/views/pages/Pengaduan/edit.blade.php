            ...
            <div class="card card-gradient">
                <div class="card-body">
                    <div class="header-section mb-4">
                        <h4 class="card-title mb-2">Form Edit Pengaduan</h4>
                        <p class="card-description">Ubah data pengaduan yang sudah ada</p>
                    </div>

                    <form class="forms-sample" action="{{ route('Pengaduan.update', $dataPengaduan->pengaduan_id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group form-card">
                                    ...
                                    <div class="input-group input-group-gradient">
                                        <input type="text" class="form-control" id="no_tiket" name="no_tiket"
                                            value="{{ old('no_tiket', $dataPengaduan->no_tiket) }}" readonly>
                                    ...
                                    <small class="form-text text-muted">
                                        ...
                                        Nomor tiket tidak dapat diubah
                                    </small>
                                </div>
                                ...
                                <div class="form-group form-card">
                                    ...
                                    <div class="select-wrapper">
                                        <select class="form-control select2" id="warga_id" name="warga_id" required style="background: linear-gradient(135deg, #ffffff 0%, #f8f9fa 100%);">
                                            ...
                                            @foreach($warga as $w)
                                                <option value="{{ $w->warga_id }}" {{ old('warga_id', $dataPengaduan->warga_id) == $w->warga_id ? 'selected' : '' }}>
                                        ...
                                        <select class="form-control select2" id="kategori_id" name="kategori_id" required style="background: linear-gradient(135deg, #ffffff 0%, #f8f9fa 100%);">
                                            ...
                                            @foreach($kategori as $k)
                                                <option value="{{ $k->kategori_id }}"
                                                    {{ old('kategori_id', $dataPengaduan->kategori_id) == $k->kategori_id ? 'selected' : '' }}
                                ...
                                @php
                                    $currentKategori = $kategori->firstWhere('kategori_id', $dataPengaduan->kategori_id);
                                    $showInfo = $currentKategori ? true : false;
                                    ...
                                    $prioritasText = $currentKategori ? ($formatPrioritas[$currentKategori->prioritas] ?? $currentKategori->prioritas) : '';
                                    $slaText = $currentKategori ? $currentKategori->sla_hari : '';
                                    ...
                                    $prioritasColorText = $currentKategori ? ($prioritasColor[$currentKategori->prioritas] ?? '#000') : '#000';
                                @endphp

                                <div class="form-card" id="info_kategori" style="display: {{ $showInfo ? 'block' : 'none' }};">
                                    <div class="info-box">
                                        <div class="info-icon">
                                        ...
                                        <div class="info-content">
                                            ...
                                            <div class="info-details">
                                                <div class="info-item">
                                                    ...
                                                    <span>Prioritas: </span>
                                                    <strong id="info_prioritas" class="text-danger" style="color: {{ $prioritasColorText }} !important;">
                                                        {{ $prioritasText }}
                                                    </strong>
                                                </div>
                                                <div class="info-item">
                                                    ...
                                                    <span>SLA: </span>
                                                    <strong id="info_sla" class="text-warning">{{ $slaText }}</strong> hari
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group form-card">
                                    ...
                                    <div class="select-wrapper">
                                        <select class="form-control select2" id="status" name="status" required style="background: linear-gradient(135deg, #ffffff 0%, #f8f9fa 100%);">
                                            ...
                                            <option value="sedang_diproses" {{ old('status', $dataPengaduan->status) == 'sedang_diproses' ? 'selected' : '' }}>Sedang Diproses</option>
                                            <option value="sudah_selesai" {{ old('status', $dataPengaduan->status) == 'sudah_selesai' ? 'selected' : '' }}>Sudah Selesai</option>
                                        </select>
                                    </div>
                                ...
                                <div class="form-group form-card">
                                    ...
                                    <div class="input-group input-group-gradient">
                                        <input type="text" class="form-control" id="judul" name="judul"
                                            ...
                                            value="{{ old('judul', $dataPengaduan->judul) }}" maxlength="100" required>
                                        <div class="input-group-append">
                                            <span class="input-group-text">
                                ...
                                <div class="form-group form-card">
                                    ...
                                    <div class="input-group input-group-gradient">
                                        <textarea class="form-control" id="deskripsi" name="deskripsi"
                                            ...
                                            maxlength="100" required>{{ old('deskripsi', $dataPengaduan->deskripsi) }}</textarea>
                                        <div class="input-group-append">
                                            <span class="input-group-text">
                                    ...
                                    <div class="char-count mt-2">
                                        <small>
                                            <span id="deskripsi_count">{{ strlen(old('deskripsi', $dataPengaduan->deskripsi)) }}</span>/100 karakter
                                        </small>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-group input-group-gradient">
                                                <input type="text" class="form-control" id="lokasi_text" name="lokasi_text"
                                                    ...
                                                    value="{{ old('lokasi_text', $dataPengaduan->lokasi_text) }}" maxlength="100" required>
                                                <div class="input-group-append">
                                                    <span class="input-group-text">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="input-group input-group-gradient">
                                                        <input type="text" class="form-control" id="rt" name="rt"
                                                            ...
                                                            value="{{ old('rt', $dataPengaduan->rt) }}" maxlength="100" required>
                                                        <div class="input-group-append">
                                                            <span class="input-group-text">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="input-group input-group-gradient">
                                                        <input type="text" class="form-control" id="rw" name="rw"
                                                            ...
                                                            value="{{ old('rw', $dataPengaduan->rw) }}" maxlength="100" required>
                                                        <div class="input-group-append">
                                                            <span class="input-group-text">
                                                                <i class="mdi mdi-numeric text-muted"></i>
                                                            </span>
                            ...
                            <div class="col-md-12">
                                <div class="d-flex justify-content-center">
                                    <button type="submit" class="btn btn-primary-gradient btn-lg mr-3">
                                        <i class="mdi mdi-content-save mr-2"></i> Update Pengaduan
                                    </button>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (deskripsi && countElement) {
            ...
            // Set warna berdasarkan jumlah karakter
            if (count > 100) {
                countElement.style.color = '#F44336';
            } else if (count > 80) {
                countElement.style.color = '#FF9800';
        ...
        // Inisialisasi info kategori saat halaman dimuat
