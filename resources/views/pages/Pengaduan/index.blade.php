                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        <div class="font-weight-bold">{{ $pengaduan->warga->nama ?? 'N/A' }}
                                                        </div>
                                                        <small
                                                            class="text-muted">{{ $pengaduan->warga->nama ?? 'N/A' }}</small>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                                <span
                                                    class="font-weight-bold">{{ $pengaduan->kategori->nama ?? 'N/A' }}</span>
                                                <br>
                                                <small class="text-muted">SLA: {{ $pengaduan->kategori->sla_hari ?? '0' }}
                                                    hari</small>
                                            </td>
                                            <td>
                                                <div class="font-weight-bold">{{ Str::limit($pengaduan->judul, 30) }}</div>
                                                <small
                                                    class="text-muted">{{ Str::limit($pengaduan->deskripsi, 40) }}</small>
                                            </td>
                                            ...
                                            <td>
                                                ...
                                                <br>
                                                <small
                                                    class="text-muted">{{ $pengaduan->created_at->format('H:i') }}</small>
                                            </td>
                                            <td>
                                                <div class="btn-group">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        ...
                                                        <form
                                                            action="{{ route('Pengaduan.destroy', $pengaduan->pengaduan_id) }}"
                                            ...
                                            <td colspan="9" class="text-center py-4">
                                                <div class="text-muted">
                                                    ...
                                                    <a href="{{ route('Pengaduan.create') }}"
                                                        class="btn btn-primary btn-sm">Tambah Pengaduan Pertama</a>
                                                </div>
                                            </td>
                                        </tr>
                                    @endforelse
