...
<div class="content-wrapper">
    ...
    <div class="d-xl-flex justify-content-between align-items-start mb-4">
        <h2 class="text-dark font-weight-bold mb-2">Tambah Data User</h2>
            ...
            <div class="card card-gradient">
                <div class="card-body">
                    <div class="header-section mb-4">
                        <h4 class="card-title mb-2">Form Data User</h4>
                            ...
                            <div class="col-md-12">
                                <div class="d-flex justify-content-center">
                                    <button type="submit" class="btn btn-primary-gradient btn-lg mr-3">
                                        <i class="mdi mdi-account-plus mr-2"></i> Tambah User
                                    </button>
...
<script>
    ...
    document.querySelector('form').addEventListener('submit', function(e) {
        ...
        submitBtn.innerHTML = '<i class="mdi mdi-loading mdi-spin mr-2"></i> Menambahkan...';
